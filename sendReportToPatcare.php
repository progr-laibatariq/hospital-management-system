...
<head>
    ...
    <title>Send Report to Pat-Care</title>
    <style>
        body {
...
<body>
    ...
    <div class="navbar">
        ...
        <div class="menu">
            ...
            <a href="SendReportToPatcare.php" class="add-report">Send Report to Pat-Care</a>
            <a href="viewReports.php" class="manage-reports">Manage Reports</a>
        </div>
        <a href="logout.php" class="logout">Logout</a>
    </div>

    <!-- Patient Report Form -->
    <form action="processSendReportToPatcare.php" method="POST" style="margin-top: 100px;">
        <h2 style="text-align: center;margin-bottom: 30px;color: #003366;">📤 Send Report to Pat-Care</h2>
