...
$doc_id = $_SESSION['doc_id'];  // ✅ Make sure this is defined before usage

// ✅ Now the deletion block
if (isset($_GET['delete_id'])) {
    $reportId = (int) $_GET['delete_id'];

    $deleteQuery = "DELETE FROM patient_report WHERE rep_id = $reportId AND doc_id = '$doc_id'";
...
<body>
    ...
    <div class="menu">
        ...
        <a href="filePatientReport.php">File Reports</a>
    ...
    if (mysqli_num_rows($result) > 0) {
        while ($row = mysqli_fetch_assoc($result)) {
            echo "<tr>
                    ...
                    <td>
                      <a href='?delete_id={$row['rep_id']}' onclick=\"return confirm('Are you sure you want to delete this report?');\">
