...
<div class="navbar">
    ...
    <div class="menu">
        ...
        <a href="assign_doc_to_pat.php" class="add-report">Assign new Doc to Pat</a>
...
<form action="process_assign_doc_to_pat.php" method="POST" style="margin-top: 100px;">    

    <h2 style="text-align: center; margin-bottom: 30px; color: #003366;">📝 Assign Doc to Pat</h2>
    ...
    <select name="doc_id"> 
        ...
        <?php 
            ...
            while ($row = $result->fetch_assoc()) {
                echo "<option value='" . $row['doc_id'] . "'>" . $row['doc_id'] . " ------- " . $row['name'] . "</option>";
            }
        ?>
    </select><br><br>
    ...
    <input type="submit" name="send" value="Assign">
